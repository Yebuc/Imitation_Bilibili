...
public interface VideoDao {
    ...
    Integer addVideos(Video video);//添加视频

    Integer batchAddVideoTags(List<VideoTag> videoTagList);//保存视频标签信息

    Integer pageCountVideos(Map<String, Object> params);

    List<Video> pageListVideos(Map<String, Object> params);//分页查询视频数据
